...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1 class="m-0">Penghargaan/Prestasi</h1>
    </div><!-- /.col -->
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{route('profile.index')}}">Profil</a></li>
            <li class="breadcrumb-item active">Penghargaan/Prestasi</li>
        </ol>
    </div><!-- /.col -->
</div><!-- /.row -->
@endsection
...
<div class="col-12">
    <div class="card card-info">
        ...
        <div class="card-body">
            <form action="{{route('profile.achievement.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="year">Tahun <span class="text-danger">*</span></label>
                            <input type="number" min="1945" max="9999" class="form-control" name="year" required>
                        </div>
                    </div>
                </div>
                <div class="form-group">
